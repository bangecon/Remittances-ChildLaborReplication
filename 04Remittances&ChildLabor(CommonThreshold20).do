...
capture log close
capture erase 20Betas.xml
capture erase 20Margins.xml
capture erase 20MarginsRM.xml
capture erase 20Betas.txt
capture erase 20Margins.txt
capture erase 20MarginsRM.txt

log using ChildLabor20, replace 
...
outreg2 using 20Betas, excel ctitle("Unbalanced - All")
margins, post dydx(_all) 
outreg2 using 20Margins, excel ctitle("Unbalanced - All")
...
outreg2 using 20MarginsRM, excel ctitle("Unbalanced - All")
logit ChildLabor rm4b##sl9c_cats hh14 sl1 hh11 sl9a hl4 hl11 hl13 ed4x wscore sn1 sn3 [pweight = hhweight], asis
outreg2 using 20Betas, excel ctitle("Unbalanced - Abroad")
margins, post dydx(_all) 
outreg2 using 20Margins, excel ctitle("Unbalanced - Abroad")
...
outreg2 using 20MarginsRM, excel ctitle("Unbalanced - Abroad")
logit ChildLabor rm4a##sl9c_cats hh14 sl1 hh11 sl9a hl4 hl11 hl13 ed4x wscore sn1 sn3 [pweight = hhweight], asis
outreg2 using 20Betas, excel ctitle("Unbalanced - Domestic")
margins, post dydx(_all) 
outreg2 using 20Margins, excel ctitle("Unbalanced - Domestic")
...
outreg2 using 20MarginsRM, excel ctitle("Unbalanced - Domestic")
